...
android {
    namespace = "com.engfred.musicplayer.feature_search"
    compileSdk = 36
...
dependencies {
    ...
    // Dependency on feature-library to access AudioFile domain model and its repository/use cases for searching
